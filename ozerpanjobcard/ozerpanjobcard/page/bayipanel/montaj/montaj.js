frappe.pages['bayipanel/montaj'].on_page_load = function(wrapper) {
	...
	// Geri butonu ekle
	let $back_btn = $(`<button class="btn btn-secondary back-btn">
		<i class="fa fa-arrow-left"></i> Geri
	</button>`).appendTo(page.main);

	// Geri butonu için event listener
	$back_btn.on('click', function() {
		frappe.set_route('bayipanel');
	});
	...
	$form.find('.btn-save').on('click', function() {
		...
		// Console'a form verilerini yazdır
		console.log('=== Montaj Formu Verileri ===');
		console.log('Müşteri Bilgileri:');
		console.log('------------------------');
		console.log('Müşteri Adı:', values.customer_name);
		console.log('Telefon:', values.customer_phone);
		console.log('Adres:', values.customer_address);
		console.log('------------------------');
		console.log('Montaj Bilgileri:');
		console.log('------------------------');
		console.log('Montaj Tarihi:', values.installation_date);
		console.log('Notlar:', values.notes);
		console.log('------------------------');
		console.log('Okutulan Barkodlar:');
		console.log('------------------------');
		values.scanned_items.forEach((item, index) => {
			console.log(`Barkod ${index + 1}:`);
			console.log('  Item Code:', item.item_code);
			console.log('  Seri No:', item.serial_no);
		});
		console.log('========================');
